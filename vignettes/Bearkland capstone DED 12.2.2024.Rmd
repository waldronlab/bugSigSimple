...
doc <- doc %>%
  body_add_img(src = "bar_graph.png", width = 6, height = 4, style = "centered")

# Save the document
print(doc, target = "bar_graph.docx")
...
# Add the image to the document
doc <- doc %>%
  body_add_img(src = "heatmap.png", width = 6, height = 4, style = "centered")

# Save the document
print(doc, target = "heatmap.docx")
```
...
# Add the image to the document
doc <- doc %>%
  body_add_img(src = "cluster_map.png", width = 6, height = 4, style = "centered")

# Save the document
print(doc, target = "cluster_map.docx")
