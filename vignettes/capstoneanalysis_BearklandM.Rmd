...
BiocManager::install(c("waldronlab/BugSigDBStats", "waldronlab/bugsigdbr"))
```
...
```{r}
as.data.frame(table(siglengths)) %>%
  kbl(col.names = c("Signature Length", "Frequency")) %>%
  kable_paper("hover", full_width = FALSE)
```
